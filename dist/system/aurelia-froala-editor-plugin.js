...
System.register(['aurelia-framework', 'aurelia-event-aggregator', 'aurelia-binding', 'aurelia-i18n'], function (_export, _context) {
	"use strict";

	var customElement, bindable, inject, EventAggregator, ObserverLocator, I18N, _dec, _dec2, _class, _desc, _value, _class2, _descriptor, _descriptor2, _descriptor3, FroalaEditor;
	...
	return {
		...
		execute: function () {
			_export('FroalaEditor', FroalaEditor = (_dec = customElement('froala-editor'), _dec2 = inject(Element, ObserverLocator, I18N, EventAggregator), _dec(_class = _dec2(_class = (_class2 = function () {
